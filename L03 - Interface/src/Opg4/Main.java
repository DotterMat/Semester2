...
public class Main {
    public static void main(String[] args) {
        ...
        Customer c1 = new Customer("Jan Eriksen", LocalDate.of(2023,8,9));
        Customer c2 = new Customer("Tove Ditlevsen", LocalDate.of(2023,8,2));
        ...
        Discount d1 = new FixedDiscount(250, 1000, "sandheden");
        c1.setDiscount(d1);
